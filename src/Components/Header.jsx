  ...
  return (
    <header className="w-full py-2 dark:bg-slate-900">
      <nav className="w-[90%] m-auto flex justify-between relative items-center text-c-dark">
        ...
        <ul className={`${ menu ? 'flex flex-row items-center max-sm:text-yellow-400 max-sm:flex-col max-sm:absolute max-sm:top-9 dark:bg-slate-900 max-sm:-right-8 max-sm:-left-8 max-sm:shadow-md z-50' : 'max-sm:hidden z-50' }`}>
          <NavLink onClick={handleCloseMenu} to="/" className={({isActive})=> isActive ? isInActive : isNotActive}>
            Home
          </NavLink>
          <NavLink onClick={handleCloseMenu}  to="/projects" className={({isActive})=> isActive ? isInActive : isNotActive}>
            Projects
          </NavLink>
          <NavLink onClick={handleCloseMenu} to="/about" className={({isActive})=> isActive ? isInActive : isNotActive}>
            About
          </NavLink>
          <NavLink onClick={handleCloseMenu} to="/contact" className={({isActive})=> isActive ? isInActive : isNotActive}>
            contact
          </NavLink>
